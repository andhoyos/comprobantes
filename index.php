...
$path = '/PHPMailer/PHPMailer.php';
//echo $directory->getPath().$path;

require $directory->getPath().'/PHPMailer/Exception.php';
require $directory->getPath().$path;
require $directory->getPath().'/PHPMailer/SMTP.php';
