...
$cont3 = "SELECT COUNT(*) as 'Historial' FROM comprobante where Presentado LIKE '%$user_name%'";
// $cont3 = "SELECT COUNT(*) as 'Historial' FROM comprobante where Rechazado NOT LIKE '' or Aprobado NOT LIKE ''";
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    <div class="w3-container w3-row">
      ...
      <div class="w3-col s8 w3-bar">
        ...
        <a href="editar_users.php" class="w3-bar-item w3-button"><i class="fa fa-user"></i></a>
    ...
    <div class="w3-bar-block">
      ...
      <a href="index_users.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-home fa-fw"></i>  Inicio</a>
      <a href="index_users.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-briefcase fa-fw"></i>  Caja chica</a>
<!--       <a href="cierre_caja_chica.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-briefcase fa-fw"></i>  Cierre de caja chica</a>
      ...
      <a href="test_historial.php" class="w3-bar-item w3-button w3-padding w3-dark-grey"><i class="fa fa-history fa-fw"></i>  Historial<span class="w3-tag w3-blue w3-round w3-right"><?php echo $result4['Historial'] ?></span></a>
      ...
      <div id="demoAcc" class="w3-hide w3-white w3-card">
        <a href="editar_users.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-wrench fa-fw"></i> Editar Perfil</a><!-- 
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-container">
      ...
      <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-color" id="tabla1">
        ...
        $Select = "SELECT Comprobante, Presentado, Destino, Motivo, Lugar, Fecha, Nro_comprobante, Total, Controlado, Aprobado FROM comprobante where Aprobado NOT LIKE '' AND Presentado LIKE '%$user_name%'";
      ...
      <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-color" id="tabla2">
        ...
        $Select = "SELECT Comprobante, Presentado, Destino, Motivo, Lugar, Fecha, Nro_comprobante, Total, Controlado, Rechazado FROM comprobante where Rechazado NOT LIKE ''AND Presentado LIKE '%$user_name%'";
        $sql = $conn->query($Select);
        if($sql-> num_rows > 0){
          while($row = $sql-> fetch_assoc()){
      ...
      <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-color" id="tabla2">
        ...
        $Select = "SELECT Comprobante, Presentado, Destino, Motivo, Lugar, Fecha, Nro_comprobante, Total, Controlado, Rechazado FROM comprobante where Rechazado LIKE '' AND Aprobado LIKE ''AND Presentado LIKE '%$user_name%'";
        $sql = $conn->query($Select);
        if($sql-> num_rows > 0){
          while($row = $sql-> fetch_assoc()){
            echo "<tr><td>".$row["Comprobante"]."</td><td>".$row["Presentado"]."</td><td>".$row["Destino"]."</td><td>".$row["Motivo"]."</td><td>".$row["Lugar"]."</td><td>".$row["Fecha"]."</td><td>".$row["Nro_comprobante"]."</td><td>".$row["Total"]."</td><td>".$row["Controlado"]."</td><td>".$row["Rechazado"]."</td></tr>";
