  ...
  <div class="w3-bar w3-top w3-blue w3-large" style="z-index:4">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
      ...
      <div class="w3-bar-block">
        ...
        <a href="index_users.php" class="w3-bar-item w3-button w3-padding w3-dark-grey"><i
         ...
         <!--  <a href="cierre_caja_chica.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-briefcase fa-fw"></i> 
          ...
          <a href="historial_users.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-history fa-fw"></i> 
          Historial<span class="w3-tag w3-blue w3-round w3-right"><?php echo $result4['Historial'] ?></span></a>
          ...
          <div id="demoAcc" class="w3-hide w3-white w3-card">
            <a href="editar_users.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-wrench fa-fw"></i> Editar
            Perfil</a>
    ...
    <div class="mb-3">
      ...
      <a class="btn btn-warning" href="index_users.php" role="button">
        Salir
      </a>
    </div>
  </form>
