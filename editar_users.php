...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="historial_users.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-history fa-fw"></i>  Historial</a>
        ...
        <div class="form-group" style="margin-left:10px;margin-right: 10px;">
          ...
          <div class="form-group" style="margin-left:10px;margin-right: 10px;">
            ...
            <?php
          			...
          			$link = '<a class="btn btn-warning" href="index.php" role="button">Salir</a>';
          			$href = 'index.php';
          			$new_href = 'index_users.php';
          			if ($_SESSION['user_rol_id'] == 3) {
